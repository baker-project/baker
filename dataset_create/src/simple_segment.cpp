...
DatasetCreate::SimpleSegment::SimpleSegment(const std::string dirt_image_path, 
					    ...
					    const int crop_residual)
{
  ...
  std::cout << "There three paths are: " 
            << dirt_image_path_ << std::endl
            << cropped_image_path_ << std::endl
            << cropped_mask_path_ << std::endl;
}
...
/*
void SimpleSegment::segement_singlechannel(int threshold_range)
{
...
void SimpleSegment::crop()
{
  ...
  cv::copyMakeBorder(dirt_frame_, dirt_frame_pad_array, crop_residual_, crop_residual_,
                     crop_residual_, crop_residual_, cv::BORDER_REPLICATE);
  cv::copyMakeBorder(mask_frame_, mask_frame_pad_array, crop_residual_, crop_residual_,
                     crop_residual_, crop_residual_, cv::BORDER_REPLICATE);
